				...
				<div className="cs-card-container">
					...
					<div className="cs-container-3">
						...
						<div className='cs-body cs-body-end'>
							<p>
								I worked on this project on and off for a few weeks. After creating a React app from scratch I felt much confident
